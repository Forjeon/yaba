...
CREATE TABLE IF NOT EXISTS Job (
	JobID TINYINT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
	JobName VARCHAR(50) NOT NULL UNIQUE,
	Wage DECIMAL(10,2) NOT NULL,
	ExpectedMonthlyHours TINYINT UNSIGNED NOT NULL,
	ExpectedMonthlyMissHours TINYINT UNSIGNED NOT NULL
);
...
CREATE TABLE IF NOT EXISTS SavingsAccount (
	...
	-- Job interface tables

CREATE TABLE IF NOT EXISTS JobIncome (
	CategoryID TINYINT UNSIGNED NOT NULL PRIMARY KEY,
	JobID TINYINT UNSIGNED NOT NULL UNIQUE,
	FOREIGN KEY (CategoryID) REFERENCES IncomeCategory(CategoryID) ON DELETE CASCADE,
